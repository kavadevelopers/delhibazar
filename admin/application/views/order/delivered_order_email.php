<?php
	$order = $this->db->get_where('payment',['id' => $id])->result_array()[0];
?>
<!DOCTYPE html>
...
<head>
	...
	<link rel="shortcut icon" type="image/png" href="<?= base_url(); ?>image/favicon.png"> 
	<style type="text/css">
			...
			<tr style="border-collapse:collapse;"> 
				...
				<table class="es-content" cellspacing="0" cellpadding="0" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;">
					<tbody>
						...
						<tr style="border-collapse:collapse;">
							<td align="center" style="padding:0;Margin:0;">
								<table class="es-header-body" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#000000;" width="600" cellspacing="0" cellpadding="0" bgcolor="#044767" align="center">
									<tbody>
										<tr style="border-collapse:collapse;">
											<td align="center" style="Margin:0;padding-top:35px;padding-bottom:35px;padding-left:35px;padding-right:35px;">
												
												<img src="<?= base_url() ?>image/logo.png" alt="" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic; width: 200px;">
																	...
																	<tbody>
																		<tr style="border-collapse:collapse;">
																			<td align="center" style="Margin:0;padding-top:25px;padding-bottom:25px;padding-left:35px;padding-right:35px;">
																					...
																					<img src="<?= base_url() ?>zoom/ok.png" alt="" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" width="120">
																				
																			</td>
																		</tr>
																		<tr style="border-collapse:collapse;">
																			<td align="center" style="padding:0;Margin:0;padding-bottom:10px;">
																				<h2 style="Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:&#39;open sans&#39;, &#39;helvetica neue&#39;, helvetica, arial, sans-serif;font-size:30px;font-style:normal;font-weight:bold;color:#333333;">Your Order Is Delivered Thankyou!</h2> 
																			</td>
																		</tr>
																	</tbody>
																</table>
																					...
																					<tbody>
																						<tr style="border-collapse:collapse;">
																							<td width="80%" style="padding:0;Margin:0;">
																								<h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:&#39;open sans&#39;, &#39;helvetica neue&#39;, helvetica, arial, sans-serif;">Order Delivered #</h4> 
																							</td>
																							<td width="20%" style="padding:0;Margin:0;">
																								<h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:&#39;open sans&#39;, &#39;helvetica neue&#39;, helvetica, arial, sans-serif;text-align: right;"><?= $order["orderid"] ?></h4> 
																							</td>
																						</tr>
																					</tbody>
																				</table>
																			...
																			<td align="left" style="Margin:0;padding-top:10px;padding-bottom:10px;padding-left:10px;padding-right:10px;">
																				<table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:500px;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left">
																					<tbody>
																						...
																						<?php 
                                            $count = count(explode(',', $order['quantity']));
                                            $qty_array          = explode(',', $order['quantity']);
                                            $pro_id_Array       = explode(',', explode('^~^', $order['product_id'])[0]);
                                            $price_Array        = explode(',', explode('^~^', $order['product_id'])[1]);
                                        ...
                                        <?php for($i = 0;$i < $count;$i++){  ?>
											...
											<tr style="border-collapse:collapse;">
												<td style="padding:5px 10px 5px 0;Margin:0;" width="80%" align="left">
													<p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:&#39;open sans&#39;, &#39;helvetica neue&#39;, helvetica, arial, sans-serif;line-height:24px;color:#333333;"><?= $this->product_model->product_id_where($pro_id_Array[$i])[0]['name'] ?> (x <?= $qty_array[$i] ?>)</p>
												</td>
												<td style="padding:5px 0;Margin:0;" width="20%" align="right">
													<p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:&#39;open sans&#39;, &#39;helvetica neue&#39;, helvetica, arial, sans-serif;line-height:24px;color:#333333;"><?= $qty_array[$i] * $price_Array[$i] ?></p>
												</td>
											</tr>
																				...
																				<table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:500px;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left">
																					<tbody>
																						<tr style="border-collapse:collapse;">
																							...
																							<td width="20%" style="padding:0;Margin:0;">
																								<h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:&#39;open sans&#39;, &#39;helvetica neue&#39;, helvetica, arial, sans-serif;text-align: right;"><?= $order["amount"] ?></h4> 
																							</td>
																						</tr>
																					</tbody>
																				</table>

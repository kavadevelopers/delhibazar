                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('stock'); ?>" type="text" name="stock" id="stock" placeholder="Stock" >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-sm" value="" type="text" name="sizes" placeholder="Sizes and Color" ><?php echo set_value('sizes'); ?></textarea>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="featured" class="form-control form-control-sm" >
                                                <option value="0" <?php if(0 == set_value('featured')) { echo "selected"; } ?>>No</option>
                                                <option value="1" <?php if(1 == set_value('featured')) { echo "selected"; } ?>>Yes</option>
                                            </select>

    ...
    <section class="content">
      	<div class="container-fluid">
            ...
            <div class="row">
                <div class="col-6">
                    <?php if($flad == 1){ ?>
                        <form method="post" action="<?= base_url(); ?>shop/update_category" enctype="multipart/form-data">
                    ...
                    <?php }else{ ?>
                        <form method="post" action="<?= base_url(); ?>shop/save_category" enctype="multipart/form-data">
                            <div class="card card-secondary"> 
                                <div class="card-header">
                                    ...
                                    <?php foreach($shop as $key => $value){ ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a class="btn btn-sm btn-primary" href="<?= base_url();?>shop/categories/<?= $value['id'];?>" title="Order">
                                                    <i class="fa fa-edit"></i>
                                                </a>

                                                <a class="btn btn-sm btn-danger" href="<?= base_url();?>shop/delete_cate/<?= $value['id'];?>" onclick="return confirm('Are you Sure You Want to Delete this ?');" title="Delete">

<title><?=$this->config->config["projectTitle"]?> | <?php echo $page_title; ?></title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12" style="text-align: center;">
                                        ...
                                        <div class="img-bannner-div">
                                            <img src="<?= base_url().'uploads/category/'.get_subcategory_image($id); ?>" class="img-bannner" alt="no images" >
                                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
                ...
                $('#upload_image').on('change', function () { readFile(this);  url = "<?= base_url('category/subcate_save_banner') ?>"; });

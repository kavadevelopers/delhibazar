            ...
            <div class="col-lg-9">
                <form class="row contact_form" action="<?= base_url() ?>pages/contact_email" method="post" id="contactForm" novalidate="novalidate">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="email" class="form-control contact-design" id="email" name="email" placeholder="Enter email address" required>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control contact-design" id="subject" name="subject" placeholder="Enter Subject" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <textarea class="form-control contact-design" name="message" id="message" rows="1" placeholder="Enter Message" required></textarea>
                        </div>
                    </div>
